...
if(isset($_POST['add']))
{
    ...
    $bed_room=(int)isset($_POST['fbedroom'])?$_POST['fbedroom']:0;
    $living_room=isset($_POST['flivingroom'])?$_POST['flivingroom']:"";
    $gust_room=isset($_POST['fgustroom'])?$_POST['fgustroom']:"";
    $kids_room=(int)isset($_POST['fkidsroom'])?$_POST['fkidsroom']:0;
    $garage=(int)isset($_POST['fgarage'])?$_POST['fgarage']:0;
    $bathroom=(int)isset($_POST['fbathroom'])?$_POST['fbathroom']:0;
    $kitchen=(int)isset($_POST['fkitchen'])?$_POST['fkitchen']:0;
    ...
    if($_SESSION['username']!="")
    {
       ...
       /* $add_design="INSERT INTO 
        designs(price,area,bed_room,kids_room,gust_room,living_room,
        bathroom,balcony,kitchen,garage,city,garden,image_design,id_person) 
        VALUES($price,$area,$kids_room,$bed_room,$gust_room,$living_room
                ,$bathroom,$balcony,$kitchen,$garage,$city,$garden,$new_img_name,$id_person)";*/
    $add_design = "INSERT INTO designs(price, area, bed_room, kids_room, gust_room, living_room,
    bathroom, balcony, kitchen, garage, city, garden, image_design, id_person) 
   VALUES ('$price', '$area', '$kids_room', '$bed_room', '$gust_room', '$living_room',
    '$bathroom', '$balcony', '$kitchen', '$garage', '$city', '$garden', '$new_img_name', '$id_person')";
...
<!--For Css file-->
    <link rel="stylesheet" href="styles/add-design-style.css">
...
<!--قسم الخاص في الصورة يحتوي الصورة وزر التحميل-->
...
<!--قسم المعلومات الخاصة بلتصميم-->
<div class="information">

<!-- Price -->
    <div>
        <label for=""> Price :</label>
        <input required type="number" placeholder="2000" name="fprice" >
    </div>

<!-- Area -->       
    <div>
        <label for=""> Area :</label>
        <input required type="number" placeholder="20" name="farea">
    </div>
...
<!--Gust Room-->
    <div class="item">
        <label for=""> Gust Room :</label>
        <select  name="fgustroom">
            <option value=''>select</option>
            <option value='North'>North</option>
            <option value='East'>East</option>
            <option value='South'>South</option>
...
<!--Kids Rooms-->
    <div class="item">
        ...
        <label for=""> Kids Rooms :</label>
        <select name="fkidsroom">
            <option value="0">0</option>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
